...
<html lang="en" class="light">
    ...
    <body class="main">
        ...
        <div data-url="side-menu-dark-file-manager.html" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
