                ...
                <div class="chat__box box">
                    ...
                    <div class="h-full flex flex-col">
                        <div class="flex flex-col sm:flex-row border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 mr-auto">
                                    ...
                                    <div class="text-gray-600 text-xs sm:text-sm"><?php echo $get_topic_author; ?><span
                        ...
                        <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                            ...
                            <div class="chat__box__text-box flex items-end float-right mb-4">
                                ...
                                <div class="bg-theme-1 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                    <?php echo $get_reply_content; ?>
                                    <div class="mt-1 text-xs text-theme-21"><?php echo $get_reply_date; ?></div>
                                </div>
                        ...
                        <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200 dark:border-dark-5">
                            ...
                            <textarea name="reply_content_message" id="reply_content_message" class="chat__box__input form-control dark:bg-dark-3 h-16 resize-none border-transparent px-5 py-3 shadow-none focus:ring-0"
                                    rows="1" placeholder="Type your message..."></textarea>

                            <button type="submit" name="submit_reply" id="submit_reply" class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-1 text-white rounded-full flex-none flex items-center justify-center mr-5">
