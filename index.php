                        ...
                        <div class="col-span-12 sm:col-span-6 xxl:col-span-3 intro-y">
                            <div class="box p-5 zoom-in">
                                <div class="flex">
                                    ...
                                    <div class="py-1 px-2 flex items-center rounded-full text-xs bg-gray-200 dark:bg-dark-5 text-gray-600 dark:text-gray-300 cursor-pointer ml-auto truncate">
                                        320 Followers
                                    </div>
                                </div>
                                <div class="mt-4">
                            ...
                            <table class="table table-report sm:mt-2">
                                ...
                                <tr class="intro-x">
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     ...
                                                     title="Uploaded at 11 June 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     class="tooltip rounded-full" src="dist/images/preview-8.jpg"
                                                     title="Uploaded at 11 December 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                    ...
                                    <td>
                                        ...
                                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">Sport &amp;
                                            Outdoor
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     ...
                                                     title="Uploaded at 27 March 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     class="tooltip rounded-full" src="dist/images/preview-3.jpg"
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     ...
                                                     title="Uploaded at 11 March 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     ...
                                                     title="Uploaded at 28 August 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     class="tooltip rounded-full" src="dist/images/preview-3.jpg"
                                                     title="Uploaded at 27 September 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     class="tooltip rounded-full" src="dist/images/preview-7.jpg"
                                                     title="Uploaded at 19 April 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                     class="tooltip rounded-full" src="dist/images/preview-12.jpg"
                                                     title="Uploaded at 19 December 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                    ...
                                    <td>
                                        ...
                                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">PC &amp; Laptop
                                        </div>
                                    </td>
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    ...
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        ...
                                        <div class="text-gray-600 mt-1">Has changed <a
                                                    class="text-theme-1 dark:text-theme-10" href="">Samsung Galaxy S20
                                                Ultra</a> price and description
                                        </div>
                                    </div>
                                </div>
                                <div class="intro-x relative flex items-center mb-3">
                                    ...
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        ...
                                        <div class="text-gray-600 mt-1">Has changed <a
                                                    class="text-theme-1 dark:text-theme-10" href="">Samsung Q90 QLED
                                                TV</a> description
                                        </div>
                                    </div>
                                </div>
